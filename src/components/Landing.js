    ...
    return (
        ...
        <div className="container landing">
            <div className="home-page">
                <h1>Hi, I am <span>Simon Sanchez</span></h1>
                ...
                <div className="social">
                    ...
                    <ul>
                        <li>
                            <a href='https://github.com/simonsanchez92' target="_blank"> <i className="fab fa-github fa-2x"></i> </a>
                        </li>
                        
                        <li>
                        <a href='http://www.linkedin.com/in/simon-sanchez-4a4011190' target="_blank"> <i className="fab fa-linkedin fa-2x"></i> </a>
                        </li>
